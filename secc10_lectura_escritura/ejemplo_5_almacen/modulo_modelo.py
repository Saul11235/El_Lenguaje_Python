# 
# APLICACION ALMACEN
# (codigo adpatado del problema de la sección 7 clases y objetos)
#
# -------------------------------------------------------
#
#
...
class modelo:  # antes class almacen
    ...
    def esInsumo(self,nombreInsumo):  # metodo nuevo
        return nombreInsumo in self.__inventario.keys()

    def get_dict(self):     return self.__inventario
    def set_dict(self,dic): self.__inventario=dic
 
# -------------------------------------------------------

# test de clase almacen

if __name__=='__main__':

    var=modelo()  # var=almacen()
    ...
    print(var.esInsumo("saco"))
    print(var.esInsumo("saco azucar"))
    print(var.get_dict())
